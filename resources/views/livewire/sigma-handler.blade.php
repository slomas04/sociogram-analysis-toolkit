    ...
    @else
        <div id="container" wire:key="graphContainer-key" class="h-screen w-full bg-white dark:bg-gray-900">
            <div class="absolute right-0.5 top-0.5 flex flex-row px-2 z-10"> 
                <button id="layout_fa2" class="border border-gray-800 dark:border-gray-200 p-2 mx-4 my-2 rounded-md cursor-pointer inline-block hover:bg-gray-100 dark:hover:bg-gray-800 bg-white dark:bg-gray-900"> 
                ...
                <button id="layout_circular" class="border border-l-0 border-gray-800 dark:border-gray-200 p-2 my-2 cursor-pointer inline-block hover:bg-gray-100 dark:hover:bg-gray-800 bg-white dark:bg-gray-900"> 
                    <span class="text-gray-800 dark:text-gray-200">
                        <ion-icon name="ellipse-outline" class="text-xl translate-y-1"></ion-icon>
                        Circular Layout
                    </span>
                </button>
                <button id="layout_noverlap" class="border border-l-0 border-gray-800 dark:border-gray-200 p-2 my-2 rounded-r-md cursor-pointer inline-block hover:bg-gray-100 dark:hover:bg-gray-800 bg-white dark:bg-gray-900"> 
                    <span class="text-gray-800 dark:text-gray-200">
                        <ion-icon name="copy-outline" class="text-xl translate-y-1"></ion-icon>
                        Noverlap
                    </span>
                </button>
            </div>
